...
const openModal = () => {
  ...
  prueba.textContent = "hola " + inputUsuario.value + ", el número de tarjeta que ingresaste: "+validator.maskify(inputNumero.value)+" no existe o te equivocaste en digitar. Deseas probar de nuevo o deseas cancelar la compra";
  //texto en html <p> 
  //p.textContent = "#####3412"
  //p.innerHtml
}
const openModalValido = () => {
  ...
  pruebaValid.textContent = "Muy bien " + inputUsuario.value + " ahora nos comunicaremos con el banco para realizar tu pago"+validator.maskify(inputNumero.value);
}
